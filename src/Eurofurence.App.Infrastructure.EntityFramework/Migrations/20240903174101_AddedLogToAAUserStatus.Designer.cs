...
namespace Eurofurence.App.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20240903174101_AddedLogToAAUserStatus")]
    partial class AddedLogToAAUserStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eurofurence.App.Domain.Model.ArtistsAlley.ArtistAlleyUserStatusChangedRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("UserStatusRecordID")
                        .HasColumnType("char(36)");

                    b.HasKey("Id");

                    b.HasIndex("UserStatusRecordID");

                    b.ToTable("ArtistAlleyUserStatusChanged");
                });

            modelBuilder.Entity("Eurofurence.App.Domain.Model.ArtistsAlley.ArtistAlleyUserStatusRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("ArtistAlleyUserStatus");
                });
            ...
            modelBuilder.Entity("Eurofurence.App.Domain.Model.ArtistsAlley.ArtistAlleyUserStatusChangedRecord", b =>
                {
                    b.HasOne("Eurofurence.App.Domain.Model.ArtistsAlley.ArtistAlleyUserStatusRecord", "UserStatusRecord")
                        .WithMany("AuditLog")
                        .HasForeignKey("UserStatusRecordID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserStatusRecord");
                });
