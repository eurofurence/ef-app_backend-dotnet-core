...
namespace Eurofurence.App.Domain.Model.Maps
{
    ...
    public class MapEntryRecord
    {
        ...
        /// <summary>
        ///     "X" coordinate of the *center* of a *circular area*, expressed as `[Relative Fraction of Map Image Width * 100]`.
        ///       *  A value of `RelativeX=50` indicates it's on the horizontal middle of a map, and results in an absolute X of 1000 on a map that is 2000 pixels wide,
        ...
        /// <summary>
        ///     "Y" coordinate of the *center* of a *circular area*, expressed as `[Relative Fraction of Map Image Height * 100]`.
        ///      *  A value of `RelativeY=50` indicates it's on the vertical middle of a map, and results in an absolute Y of 1000 on a map that is 2000 pixels in height,
